	...
	<div id="user-contents">
		<div class="width100">
			...
			<div class="column_between align_center width100" style="height: 506px; background: #EEF0F0; padding: 170px 0">
				...
				<button class="font-size-28 main_button" onclick="location.href='/topic=frame'">맞춤 프레임 알아보기 →</button>
			</div>
			...
			<div class="column_center">
				...
				<div class="column_between align_center width100" style="height: 506px; background: #EEF0F0; padding: 170px 0">
					...
					<button class="main_button" onclick="location.href='/topic=lens'">맞춤 렌즈 알아보기 →</button>
				</div>
...
<!-- 						</div> -->
						...
						<div class="carousel-inner">
							<div class="carousel-item">
								<c:forEach items="${storeList }" var="list" varStatus="status">
									<div style="display: flex; flex-direction: column;"> 
										<div style="background-image: url(${list.simg}); width: 961px; height: 788px; background-size: 100% 100%"></div>
										<div class="carousel_text_box">
											<div class="font-size-32 weight500">${list.sname }</div>
											<div class="carousel_text_detail font-size-24 weight400">
												<div class="column_between" style="height: 80px;">
													${fn:replace(list.stext, replaceChar, "<br/>")}
												</div>
												<div>${list.sphone }</div>
